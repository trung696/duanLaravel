<div class="flex justify-center my-6">
    <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y">
        @if(Session::has('message'))
            <div >
                 <p class="w-64 px-4 py-2 bg-green-500 text-white text-center rounded-md">{{ Session::get('message') }}</p>
            </div>
        @endif
        <div class="flex-1">
            @if(Cart::count() > 0)
                <div class="flex justify-between">
                                    ...
                                    <div class="">
                                        <div class="relative flex flex-row  w-full h-8">
                                            ...
                                            <input type="text" value="{{ $item->qty }}" pattern="[0-9]*"
                                                   class="w-14 font-semibold text-center text-gray-700 bg-gray-200 outline-none focus:outline-none hover:text-black focus:text-black"/>
                    ...
                    <div class="lg:px-2 lg:w-1/2 bg-blue-100 mx-4 py-2">
                        <div class="p-4 bg-gray-100 rounded-full">
                            <h1 class="ml-2 font-bold uppercase">Chi tiết thanh toán</h1>
                        </div>
                        <div class="p-4">
