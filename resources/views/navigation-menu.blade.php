        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('admin.services') }}" :active="request()->routeIs('admin.services')">
                        {{ __('Services') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('admin.categories-new') }}" :active="request()->routeIs('admin.categories-new')">
                        {{ __('Category-New') }}
                    </x-jet-nav-link>  <x-jet-nav-link href="{{ route('admin.blogs') }}" :active="request()->routeIs('admin.blogs')">
                        {{ __('News') }}
                    </x-jet-nav-link>
{{--                    <x-jet-nav-link href="{{ route('admin.orders') }}" :active="request()->routeIs('admin.orders')">--}}
{{--                        {{ __('Orders') }}--}}
{{--                    </x-jet-nav-link>  <x-jet-nav-link href="{{ route('admin.orders') }}" :active="request()->routeIs('admin.orders')">--}}
{{--                        {{ __('Orders') }}--}}
{{--                    </x-jet-nav-link>--}}
